function C = gdct2_fwd(x,is_real,is_unif,xo,yo,typeNUFFT,sz,R_high,R_low,rad,is_cos,t_sc,s_sc,wedge_length_coarse)
% gdct2_fwd.m - 2D Generalized Discrete Curvelet Transform
%
% Inputs
%   x           N1-by-N2 matrix
%
...
%Pos_angle(pos) = acos(Pos_index_2(pos)./Pos_radius(pos));
%pos = find(Pos_index_1<0);
%Pos_angle(pos) = 2*pi-Pos_angle(pos);
if 1
