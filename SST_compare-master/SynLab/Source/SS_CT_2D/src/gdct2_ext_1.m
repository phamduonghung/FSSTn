function C = gdct2_ext_1(x, is_real,is_unif,xo,yo,typeNUFFT,sz,R_high,R_low,  rad,is_cos, t_sc, s_sc, wedge_length_coarse)
% gdct2_ext_1.m - Derivertive of 2D generalized Discrete Curvelet Transform
